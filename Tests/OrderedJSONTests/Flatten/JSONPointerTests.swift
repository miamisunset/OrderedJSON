...
struct JSONPointerErrorTests {
    ...
    @Test("pointer leading zero rejected multi segment") func pointerLeadingZeroRejectedMultiSegment() throws {
        let error = #expect(throws: JSONPointerError.self) {
...
struct JSONPointerFragmentTests {
    ...
    @Test("pointer fragment invalid percent encoding") func pointerFragmentInvalidPercentEncoding() throws {
        let error = #expect(throws: JSONPointerError.self) {
...
struct JSONPointerFlattenTests {
    ...
    @Test("unflatten array path without leading slash") func unflattenArrayPathWithoutLeadingSlash() throws {
