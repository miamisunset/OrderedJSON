...
public extension JSON {
    ...
    subscript(key: String) -> JSON? {
        ...
        set {
            guard case var .object(dict) = storage else {
    ...
    func at(_ key: String) throws -> JSON {
        guard case let .object(dict) = storage else {
    ...
    func value(_ key: String, default defaultValue: JSON) -> JSON {
        guard case let .object(dict) = storage else { return defaultValue }
    ...
    func value(_ index: Int, default defaultValue: JSON) -> JSON {
        guard case let .array(arr) = storage else { return defaultValue }
    ...
    subscript(dynamicMember member: String) -> JSON {
        get {
            guard case let .object(dict) = storage else { return .null }
