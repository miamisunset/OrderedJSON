...
public struct JSONParseError: Error, CustomStringConvertible, Hashable, Sendable {
    ...
    public var description: String {
        ...
        case let .depthExceeded(line, column, depth, maxDepth):
            return
